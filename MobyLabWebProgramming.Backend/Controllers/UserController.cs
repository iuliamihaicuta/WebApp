...
{                                                                                         // Also, you may pass constructor parameters to a base class constructor and call as specific constructor from the base class.
    ...
    [HttpGet("{id:guid}")] // This attribute will make the controller respond to an HTTP GET request on the route /api/User/GetById/<some_guid>.
    ...
    /// </summary>
    [Authorize]
    [HttpGet] // This attribute will make the controller respond to an HTTP GET request on the route /api/User/GetPage.
    ...
    /// </summary>
    [Authorize]
    [HttpPost] // This attribute will make the controller respond to an HTTP POST request on the route /api/User/Add.
    ...
    /// </summary>
    [Authorize]
    [HttpPut] // This attribute will make the controller respond to an HTTP PUT request on the route /api/User/Update.
